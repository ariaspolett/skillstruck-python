#Checkpoint
string1 = "I love ice cream!"
check = "ice" not in string1
print(check)

#Challenge - Check for Word
string1 = input("please enter a sentence")
check = "armadillo" in string1
print(check)

#Challenge - Check for Letter
string1 = input("please enter a sentence")
check = "a" in string1
print(check)
...
#Challenge - Are Cassowaries Dangerous?
